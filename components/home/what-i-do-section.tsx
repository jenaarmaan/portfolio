  ...
  const areas = [
    {
      ...
      description: "Designing and deploying ML models for real-world applications, from computer vision to NLP.",
      icon: (
    ...
    },
    {
      ...
      description: "Building scalable, distributed systems that handle millions of requests with reliability.",
      icon: (
        <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
    ...
    },
    {
      ...
      description: "Exploring cutting-edge AI techniques and publishing findings in academic venues.",
      icon: (
        <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
